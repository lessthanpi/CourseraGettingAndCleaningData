...
#we finally use this file to do something
#saw something on Stack Exchange that gave the
...
#******************************************************************
#Step V: 2nd Dataset with means by Subject_ID and Activity_ID.
#******************************************************************
...
#output to wd
write.table(tidy_Data, "./coursera wrangling/FinalData.txt", row.name=FALSE)
